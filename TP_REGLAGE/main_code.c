...
//----------------------  CONSTANTES PID ---------------------------------------
float Kp = 6;       // Kp (proportionnel)  
float Ki = 8;       // Ki (intégrateur)
float Kd = 15;       // Kd (dérivateur)
...
int main(int argc, char** argv) 
{
    ...
    RPINR14bits.QEA1R = 6;      // correspond à la pin RP6 => B 
    RPINR14bits.QEB1R = 5;      // correspond à la pin RP5 => A 
